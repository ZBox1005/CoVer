...
Wraps timm (https://github.com/rwightman/pytorch-image-models) DNNs for use as a vision tower in CLIP model.
"""
import logging
...
class TimmModel(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        if timm is None:
            raise RuntimeError("Please `pip install timm` to use timm DNNs.")
        self.image_size = to_2tuple(image_size)

        # setup kwargs that may not be common across all DNNs
        timm_kwargs = {}
