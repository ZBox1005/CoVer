...
class DistortImageFolder(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # # ImageNet-C
        save_path = 'datasets/ImageNet/Distorted/val/' + self.method.__name__ + \
                    '/' + str(self.severity) + '/' + self.idx_to_class[target]

        # # Texture-C
        # save_path = 'datasets/ImageNet_OOD_dataset/Distorted/dtd/images/' + self.method.__name__ + \
        #             '/' + str(self.severity) + '/' + self.idx_to_class[target]
...
def save_distorted(method=gaussian_noise):
    for severity in range(1, 6):
        ...
        distorted_dataset = DistortImageFolder(
            ...
            # # Texture-C
            # root="datasets/ImageNet_OOD_dataset/dtd/images",
        ...
        distorted_dataset_loader = torch.utils.data.DataLoader(
            distorted_dataset, batch_size=512, shuffle=False, num_workers=4)
